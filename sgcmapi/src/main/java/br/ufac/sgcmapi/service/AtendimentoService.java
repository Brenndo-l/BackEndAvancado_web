...
public class AtendimentoService implements ICrudService<Atendimento>, IPageService<Atendimento> {
    ...
    public List<Atendimento> get(String termoBusca) {
        System.out.println("Consultando todos atendimentos com termo de busca  '" + termoBusca + "' Sem cache");
        ...
        var ordenacao = Sort.by(Sort.Direction.ASC, "data");
    ...
    public Page<Atendimento> get(String termoBusca, Pageable page) {
        System.out.println("Consultando atendimentos " + termoBusca + " Sem cache");
